    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_exam_servers", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_candidate_sync_logs_CandidateId_ServerId",
                table: "candidate_sync_logs",
                columns: new[] { "CandidateId", "ServerId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_candidates_BatchId_CandidateNo",
                table: "candidates",
                columns: new[] { "BatchId", "CandidateNo" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_candidates_BatchId_SyncStatus",
                table: "candidates",
                columns: new[] { "BatchId", "SyncStatus" });

            migrationBuilder.CreateIndex(
                name: "IX_exam_batches_BatchCode",
                table: "exam_batches",
                column: "BatchCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_exam_scores_CandidateId_Subject",
                table: "exam_scores",
                columns: new[] { "CandidateId", "Subject" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_exam_scores_PushStatus_ScoredAt",
                table: "exam_scores",
                columns: new[] { "PushStatus", "ScoredAt" });

            migrationBuilder.CreateIndex(
                name: "IX_exam_servers_ServerId",
                table: "exam_servers",
                column: "ServerId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_score_push_logs_ExamScoreId",
                table: "score_push_logs",
                column: "ExamScoreId");
        }
